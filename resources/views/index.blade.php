...
<head>
    ...
    <title>لرن تیچ | آموزش برنامه‌ نویسی و طراحی وب</title>
    <meta name="description"
          content="لرن تیچ وبسایت آموزش برنامه نویسی وب و موبایل ، جاوااسکریپت ، لاراول ، react ، آموزش node js با مجرب ترین مدرسین">
    <meta name="keywords"
          content="آموزش طراحی سایت,آموزش برنامه نویسی,طراحی وب,ساخت وب سایت,آموزش git,آموزش لاراول,آموزش php,آموزش react,آموزش پی اچ پی,آموزش laravel,آموزش جاوا اسکریپت,آموزش ساخت وب سایت,آموزش mvc,آموزش React Native,لرن تیچ , وب اموز">
    <link rel="canonical" href="https://webamooz.net"/>
    <meta property="og:title" content="لرن تیچ | آموزش برنامه‌ نویسی و طراحی وب"/>
    <meta property="og:description"
          content="لرن تیچ وبسایت آموزش برنامه نویسی وب و موبایل ، جاوااسکریپت ، لاراول ، react ، آموزش node js با مجرب ترین مدرسین"/>
    <meta property="og:url" content="https://webamooz.net"/>
    <meta property="og:site_name" content="وبسایت آموزشی لرن تیچ"/>
    <meta property="og:brand" content="لرن تیچ"/>
    ...
    <div class="container">
        <div class="t-header-row">
            <div class="t-header-right">
                <div class="t-header-logo"><a href="index"></a></div>
            ...
            <div class="t-header-left">
                ...
                <div class="join-teachers" hidden>
                    <a href="become-a-teacher.html">تدریس در لرن تیچ</a>
                </div>
    ...
    <nav id="navigation" class="navigation">
        ...
        <div class="container">
            <ul class="nav">
                ...
                <li class="main-menu join-teachers-li"><a href="become-a-teacher.html">تدریس در لرن تیچ</a></li>
...
<footer>
    ...
    <div class="webamooz">
        ...
        <a href="https://webamooz.net">لرن تیچ</a>
        © 1399
    </div>
</footer>
